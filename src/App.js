...
const resObj = {
    "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-10-29 23:00:00",
          "opened": true
        },
        "badges": {
          "imageBadges": [
      ...
      "analytics": {
        "context": "seo-data-cd96c8cb-688d-484d-98b2-3533acce3034"
      },
      "cta": {
...
const Body = () =>{
    return(
        <div className="body">
            ...
            <div className="rest-continer">
                <ReastruntCard resData={resObj}/>
            </div>
        </div>
    )
}
